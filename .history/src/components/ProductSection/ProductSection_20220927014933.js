  ...
  return (
    <div className='test-card'>
      {contextData.allProducts.filter(product => (product.isShowHome === true)).map(filterName => (
        <Card style={{ width: '18rem' , height:'30rem', margin:'1rem 3rem' ,paddingTop:'5px' , marginRight:'40px'}}>
          ...
          <Card.Body>
            ...
            <Card.Text style={{overflow:'hidden' ,height:'110px' , margin:'20px 0' ,fontWeight:'300'}}>{filterName.desc}</Card.Text>
