  ...
  return (
    <div className='test-card'>
      {contextData.allProducts.filter(product => (product.isShowHome === true)).map(filterName => (
        <Card style={{ width: '18rem' , height:'30rem', margin:'1.5rem 2.5rem' ,paddingTop:'5px' }}>
          ...
          <Card.Body>
            ...
            <Card.Text style={{overflow:'hidden' ,height:'110px' , margin:'20px 0' ,fontWeight:'300' ,fontSize:'10px'}}>{filterName.desc}</Card.Text>
